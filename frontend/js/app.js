...
const CONFIG = {
    pacientes: {
        title: 'Pacientes',
        endpoint: `${API_BASE_URL}/api/pacientes`,
    ...
    medicos: {
        title: 'Médicos',
        endpoint: `${API_BASE_URL}/api/v1/medicos`,
    ...
    especialidades: {
        ...
        endpoint: `${API_BASE_URL}/api/v1/especialidades`,
    ...
    consultas: {
        title: 'Consultas',
        endpoint: `${API_BASE_URL}/api/v1/consultas`,
    ...
    prontuarios: {
        title: 'Prontuários',
        endpoint: `${API_BASE_URL}/api/v1/prontuarios`,
    ...
    apikeys: {
        title: 'API Keys',
        endpoint: `${API_BASE_URL}/api/v1/auth/keys`,
